...
public sealed class OpenDocumentCommandHandler : ICommandHandler<OpenDocumentCommand, DocumentSession>
{
    private readonly DesignerRuntime _runtime;

    public OpenDocumentCommandHandler(DesignerRuntime runtime)
    {
        _runtime = runtime;
    }

    public ICommandResult<DocumentSession> Execute(OpenDocumentCommand command)
    {
